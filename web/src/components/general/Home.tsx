  ...
  return (
    <div className=" overflow-hidden h-screen w-screen">
      <div className="w-screen h-screen md:grid grid-cols-2 items-center justify-center hidden">
        <div className="flex items-center justify-center flex-col gap-5 px-24">
          <div className="text-8xl font-black logoFont text-transparent bg-clip-text bg-gradient-to-r from-navy-500 to-sky-300">
            Goal Climber
          </div>
          <div className="text-3xl text-navy-500 text-center">
          ...
          <div className="flex items-center justify-center flex-row gap-4 mt-4">
            <button
              className="h-16 bg-navy-500 text-white lg:w-48 w-40 rounded-lg lg:text-2xl text-xl font-bold hover:brightness-90"
              onClick={() => nav("/login")}
            >
              {" "}
              Log In
            ...
            <button
              className="h-16 bg-white text-navy-500 border-4 border-navy-500 lg:w-48 w-40 rounded-lg lg:text-2xl text-xl font-bold hover:brightness-90"
              onClick={() => nav("/signup")}
            >
              {" "}
              Sign Up
